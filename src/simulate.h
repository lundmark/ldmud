...
extern void compile_update_candidate(string_t *origin, program_t *expected,
                                     program_t **result);
#endif
#if defined(DEBUG) && defined(BLUEPRINT_UPDATE_TESTING)
#define COMPILE_TEST_DIAGNOSTIC 1
#define COMPILE_TEST_TYPE_CONTEXT 2
#define COMPILE_TEST_PROLOG 3
#define COMPILE_TEST_PROVISIONAL 4
#define COMPILE_TEST_ADOPTED 5
#define COMPILE_TEST_TYPE_ALLOCATION 6
#define COMPILE_TEST_SOURCE_NAME 7
#define COMPILE_TEST_INCLUDE_INPUT 8
#define COMPILE_TEST_PRESSURE_DIAGNOSTIC 9
#define COMPILE_TEST_PRESSURE_INHERIT 10
#define COMPILE_TEST_PREPROCESSOR_STRING 11
#define COMPILE_TEST_PREPROCESSOR_APPEND 12
#define COMPILE_TEST_HOOK_ARGUMENT 13
#define COMPILE_TEST_PRESSURE_STRUCT_INIT 14
#define COMPILE_TEST_PRESSURE_CLEANUP 15
#define COMPILE_TEST_FUNCTION_STORAGE 16
#define COMPILE_TEST_VARIABLE_STORAGE 17
#define COMPILE_TEST_TYPE_STORAGE 18
#define COMPILE_TEST_ARGUMENT_STORAGE 19
#define COMPILE_TEST_SHADOW_STORAGE 20
#define COMPILE_TEST_LOCAL_IDENTIFIER 21
#define COMPILE_TEST_LOCAL_DEBUG 22
#define COMPILE_TEST_STRUCT_MEMBER 23
#define COMPILE_TEST_INLINE_STORAGE 24
#define COMPILE_TEST_STRUCT_NAME 25
#define COMPILE_TEST_ARGUMENT_STACK 26
#define COMPILE_TEST_INLINE_LOCALS 27
#define COMPILE_TEST_BYTES_KEYWORD 28
#define COMPILE_TEST_SETUP_IDENTIFIER 29
#define COMPILE_TEST_CALL_PREFIX 30
#define COMPILE_TEST_INLINE_HEADER 31
...
extern int  setup_closure_callback(callback_t *cb, svalue_t *cl, int nargs, svalue_t * args, bool expect_code);
